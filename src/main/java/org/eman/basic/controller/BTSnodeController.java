...
import org.eman.basic.facade.BTSnodeFacade;
...
public class BTSnodeController implements Serializable {
    ...
    @EJB protected org.eman.basic.facade.BTSnodeFacade ejbFacade;
...
public  List<BTSnode> getFilteredValue() {
    ...
    public void setFilteredValue(List<BTSnode> filteredValue){
